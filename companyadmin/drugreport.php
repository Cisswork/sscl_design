...
<div class="container">
  <div class="page-inner">
    <div class="page-header">
      <h3 class="fw-bold mb-3">Drug Test Record Form</h3>
      ...
      <div class="col-md-12">
        <div class="card shadow-lg">
          <div class="card-header text-white d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0" style="color: #000000;"><i class="fas fa-file-medical-alt me-2"></i>Drug Test Record Form</h4>
          </div>
          <div class="card-body p-4">
            <form>
                <!-- Specimen Info -->
                <div class="form-group">
                    <label for="drugs" class="form-label">Upload Drugs Report</label>
