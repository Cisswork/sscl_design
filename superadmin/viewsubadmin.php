    ...
    <div class="page-inner">
        <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="viewsubadmin.php">Subadmin Management</a>
                </li>
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
                <li class="nav-item">
                  <a href="viewsubadmin.php">View Subadmin</a>
                </li>
              </ul>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      ...
                      <a href="addsubadmin.php" class="btn btn-primary btn-round ms-auto" style="border-color: #f5f7fd !important; color: #fff; font-weight: bold;">
