  ...
  <div class="page-inner">
    ...
    <div class="card shadow-lg">
      ...
      <form>
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p>
                ...
                Date Completed: <input type="date" id="last-name" name="c_date" placeholder="Enter the date">
              </p>
            </div>
        </div>
        <div class="section">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <select id="result" onchange="updateResult(this)">
                  <option value="CLEARED">CLEARED</option>
                  <option value="NOT CLEARED">NOT CLEARED</option>
                  <option value="NOT RECOMMENDED">NOT RECOMMENDED</option>
                </select>
                
                <span id="resultDisplay" style="font-weight: bold; margin-left: 10px;">CLEARED</span>
                
                <!-- Hidden input shown conditionally -->
                <div id="reasonField" style="display: none;">
                  <label for="reason">Reason for Not Clearing:</label>
          ...
          <div class="row">
            <div class="col-md-6">
              <label for="result"><b>Red Flags:</b></label>
            </div>
            <div class="col-md-6">
                <select id="redFlag" onchange="handleRedFlag(this)">
                  <option value="Nothing Adverse">Nothing Adverse</option>
                  <option value="Others">Others</option>
                  <!--<option value="Pending Investigation">Pending Investigation</option>-->
                </select>
                
                <span id="redFlagDisplay" style="font-weight: bold; margin-left: 10px;">Nothing Adverse</span>
                
                <!-- Always show input when any option is selected -->
                <div id="redFlagInputField" style="display: none;">
                  <label for="redFlagDetails">Provide Details:</label>
                  <input type="text" id="redFlagDetails" name="redFlagDetails" placeholder="Enter details">
                </div>
            </div>
          </div>
        </div>
        <div class="section">
          <h3>IDENTIFICATION - <select id="confirmation" onchange="handleConfirmation(this)" style="width: 20%;">
          ...
          <div class="row">
            <div class="col-md-4">
              <label for="last-name">Applicant’s:</label>
            </div>
            <div class="col-md-4">
        ...
        <div class="section">
          <h3>RESIDENCY- <select id="confirmation" onchange="handleConfirmation(this)" style="width: 20%;">
                          <option value="">-- Select Status --</option>
                          <option value="CONFIRMED">CONFIRMED</option>
                          <option value="NOT CONFIRMED">NOT CONFIRMED</option>
                        </select>
...
<script>
  ...
  function updateResult(select) {
    ...
    if (value === "CLEARED") {
      ...
      resultDisplay.style.color = "skyblue";
      reasonField.style.display = "none";
    }
  }

  // Optional: Trigger on page load
  updateResult(document.getElementById('result'));
</script>

<script>
  const redFlagDisplay = document.getElementById('redFlagDisplay');
  const redFlagInputField = document.getElementById('redFlagInputField');

  function handleRedFlag(select) {
    const value = select.value;
    redFlagDisplay.textContent = value;

    // Color logic
    if (value === "Nothing Adverse") {
      redFlagDisplay.style.color = "green";
    } else if (value === "Others") {
      redFlagDisplay.style.color = "red";
    } else if (value === "Pending Investigation") {
      redFlagDisplay.style.color = "orange";
    }

    // Show input field for all values
    redFlagInputField.style.display = "block";
  }

  // Optional: Trigger on page load
  handleRedFlag(document.getElementById('redFlag'));
</script>
